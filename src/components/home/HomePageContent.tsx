...
-  );
-}
+    <path fill="#1976D2" d="M43.611 20.083H42V20H24v8h11.303c-.792 2.237-2.231 4.166-4.087 5.574l6.19 5.238C42.012 36.49 44 30.86 44 24c0 22.659-43.862 21.35-43.611 20.083z"/>
+  </svg>
+);
+
+export function HomePageContent() {
...
+
+  useEffect(() => {
+    // This logic is now handled in AuthProvider/LayoutWrapper
+    if (!loading && user) {
+      router.push("/dashboard");
+    }
+  }, [user, loading, router]);
