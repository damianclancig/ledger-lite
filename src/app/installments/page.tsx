                   ...
                   <div className="col-span-12 md:col-span-4">
                    ...
                    <div className="col-span-12 md:col-span-6">
                        <div className="flex justify-between items-center text-xs text-muted-foreground mb-1">
                            <span className="capitalize">{translations.purchaseDate}: {format(new Date(item.purchaseDate), 'dd/MM/yyyy', { locale: currentLocale })}</span>
          ...
          <TableBody>
            {completedDetails.map((item) => (
              <TableRow key={item.id}>
                ...
                <TableCell className="text-base">{format(new Date(item.purchaseDate), 'PPP', { locale: currentLocale })}</TableCell>
        ...
        <Card key={item.id} className="shadow-lg border-2 border-primary/20 overflow-hidden">
          <CardContent className="p-4 space-y-3">
              ...
              <div className="grid grid-cols-2 gap-x-4 gap-y-2 text-base text-muted-foreground">
                  ...
                  <div className="flex items-center"><ShoppingBag className="h-4 w-4 mr-2" /><span>{format(new Date(item.purchaseDate), 'PPP', { locale: currentLocale })}</span></div>
